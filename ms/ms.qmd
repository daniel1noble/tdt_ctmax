...
We analysed the thermal death time curves for 8 new species of *Drosophila* using the same methods as @Jorgensen2019, using linear models with log 10 coma time as the response and assay temperature as the predcitor [@fig-tdt]. We then used the model to estimate the slope and intercept ($CT_{max}$) for each species [@tbl-1]. 
