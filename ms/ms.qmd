...
# Plot 2
plot(check_z$trait ~ check_z$est, ylab = "TDT Slope (z)", xlab = "Estimated TDT Slope", pch = 16, cex = 3, cex.lab = 2)
abline(a = 0, b = 1, col = "red")
