...
# We'll also z-transofmr to make the coprrelation stuff easier to calculate. 
...
# Extract the estmated / imputaed Z for each species, but drop internal ancestral nodes
